...
class AppController:
    def __init__(self, settings):
        ...
        self._player = Player()
        self._player.set_finished_file_handler(lambda: on_playback_finished(self._ctx))
        self._rec = RecEngine()
        ...
        # The custom bridge is the single Windows media command/status owner; MPV remains playback owner.
